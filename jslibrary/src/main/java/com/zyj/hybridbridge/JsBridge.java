...
public class JsBridge {
    ...
    public JsBridge addJsAction(String action, Class<? extends JsAction> jsActionImp) {
    ...
    private void addJavascriptInterface(WebView webView) {
        webView.addJavascriptInterface(new NativeInterface(mHandleJsMessage), "native");
    }
