...
import com.brotherd.androidhtmlcommunicatedemo.framework.entity.JsMsgPhotoEntity;
    ...
    protected void handleAction(Activity context, String jsonStr) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            context.requestPermissions(
                    new String[]{"android.permission.WRITE_EXTERNAL_STORAGE", "android.permission.CAMERA"}, 10000);
        }
